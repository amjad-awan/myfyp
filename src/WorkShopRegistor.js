...
const WorkShopRegistor = () => {
          ...
          const handleLocation = (e) => {
                    Geocode.setApiKey(
                              "AIzaSyB7R4wPyILvLMpGIN8zOCAA52oSPpLdLWQ"
                    );
                    setAddress(e);
          ...
          const showError = (error) => {
                    ...
                    switch (errorCode) {
                              ...
                              case "auth/code-expired":
                                        notificationSvc.error(
                                                  "Code expired please verify captcha again"
                                        );
                                        break;
...
>>>>>>> 611b2f783f3f2ae09152d3a05c37a705039636f2
};
